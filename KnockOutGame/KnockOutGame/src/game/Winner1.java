 ...
 */
public class Winner1 implements CollisionListener {
    ...
    /**
     * Allows the game to progress when Player 1's score has reached a certain amount
     * @param stage The stage being currently played
     * @param game The game state
     */
    public Winner1(GameStage stage, Game game) {
        this.stage = stage;
        this.game = game;
    ...
    public void collide(CollisionEvent e)  {
        if (e.getOtherBody() instanceof Walls && stage.p1Wins() == true )
                 {
            try {
                game.goToNextStage();
